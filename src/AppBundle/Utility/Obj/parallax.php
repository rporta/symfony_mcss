...
class parallax extends createClass
{
	...
	public function refreshInfo(){
		...
		$tempHtml = '<div id="{ID}" class="parallax-container {TEXTCOLOR} {BACKGROUNDCOLOR} {CONTAINER} {VALIGN} {TEXTALING} {FLOAT} {SHADOW} {TRUNCATE} {CARDPANEL} {HOVERABLE}"><div class="parallax">{obj:html}</div></div>';
		$tempHtml = str_replace($search, $replace, $tempHtml);

		$this->js[] = " $('.parallax').parallax(); ";
		$this->html = $tempHtml;
	}
	public function addObj(media $obj){
		$this->obj[] = $obj;
		$this->refreshInfo();
	}

	public function delObj(media $obj){
