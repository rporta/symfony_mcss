...
class inputTextarea extends createClass
{
	public $id;
	public $type;
	public $html;
	...
	public function __construct($arg = NULL){
		$this->id = 'inputTextarea-'.$this->createID(5);
		$this->type = 'inputTextarea';
	...
	public function refreshInfo(){
		...
		'<div class="input-field">
			...
			{obj:html}
			<textarea {PLACEHOLDER} {NAME} {DISABLED} {CHARACTERCOUNTER} {VALUE} id="{ID}" type="{MODE}" class="materialize-textarea {TEXTCOLOR} {BACKGROUNDCOLOR} {TEXTALING} {SHADOW} {TRUNCATE} {CARDPANEL} {HOVERABLE} {ACTIVE} "></textarea>
