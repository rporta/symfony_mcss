...
class header extends createClass
{
	public $id;
	public $type;
	public $html;
	...
	public function __construct($arg = NULL){
		$this->type = 'header';
		$this->id = 'header-'.$this->createID(5);
	...
	public function refreshInfo(){
		...
		$tempHtml = '<header id="{ID}" class="{TEXTCOLOR} {BACKGROUNDCOLOR} {CONTAINER} {VALIGN} {TEXTALING} {FLOAT} {SHADOW} {TRUNCATE} {CARDPANEL} {HOVERABLE}">{obj:html}</header>';
