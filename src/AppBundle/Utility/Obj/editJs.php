			...
			"
				$(document).click(function(e){
					...
					if( $(\"#alert-72197\").length){
						...
						/*agrego alerta*/
						$('body').append(    
							'<style>.pantalla-full{overflow-y: scroll !important;min-width: 100% !important;min-height: 100% !important;width: 100% !important;height: 100% !important;top: 0% !important;}<\/style><div id=\"alert-72197\" style=\"overflow-y: hidden;\" class=\" white modal modal-fixed-footer\"><div class=\"modal-content center-align \"><div id=\"fjfj\"><p id=\"p-b41dd\" class=\"black-text transparent center-align\">Desea agregar un nuevo objeto dentro de este objeto : <\/p><br>'+element+'<\/div><\/div><div class=\"modal-footer \"><div class=\"center-align afbtn\"><button id=\"inputButton-ceab0\" href=\"#\" class=\"btn btn-flat\">aceptar<\/button>    <button id=\"inputButton-ceab1\" href=\"#\" class=\"btn btn-flat modal-action modal-close\">cancelar<\/button></div><\/div><script type=\"text/javascript\">$(\"#alert-72197\").modal({complete: function(e) {  $(\"#alert-72197\").remove(); }}); $(\"#alert-72197\").modal(\"open\");  $(\"#inputButton-ceab0\").click(function(){ preloaderFull(\"on\", pF); setTimeout(function(){ $(\"#alert-72197\").addClass(\"pantalla-full\"); $(\"#alert-72197\").removeClass(\"modal-fixed-footer\"); $(\"#fjfj\").addClass(\"container\"); }, 1000); $.ajax({ url: \"/ajaxadd/{$editar}\", data: ObjHtmlElement, dataType:\"JSON\", type: \"POST\", success: function(data) {setTimeout(function(){ preloaderFull(\"off\", pF); }, 500); $(\"#fjfj\")[0].innerHTML += data[0]; eval(data[1]); $(\"#inputButton-ceab0\").remove(); $(\".afbtn\").prepend(\'<button id=\"agregar\" href=\"#\" class=\"btn btn-flat\">agregar<\/button>\');$(\"#agregar\").click( function(){ $(\"#\"+data[2]+\"\").submit(); } );/*--------------aca va funcion click para enviar formulario---------------*/console.log($(\"#inputButton-ceab0\")); console.log($(\"#\"+data[2]+\"\"));} });});<\/script><\/div>'
						);	
					}
					});
			...
			"
				$(document).click(function(e){
					...
					if( $(\"#alert-72197\").length){
						...
						/*agrego alerta*/
						$('body').append( 
							'<style>.pantalla-full{overflow-y: scroll !important;min-width: 100% !important;min-height: 100% !important;width: 100% !important;height: 100% !important;top: 0% !important;}<\/style><div id=\"alert-72197\" style=\"overflow-y: hidden;\" class=\" white modal modal-fixed-footer\"><div class=\"modal-content center-align \"><div id=\"fjfj\"><p id=\"p-b41dd\" class=\"black-text transparent center-align\">Desea modificar este objeto : <\/p><br>'+element+'<\/div><\/div><div class=\"modal-footer \"><div class=\"center-align afbtn\"><button id=\"inputButton-ceab0\" href=\"#\" class=\"btn btn-flat\">aceptar<\/button>    <button id=\"inputButton-ceab1\" href=\"#\" class=\"btn btn-flat modal-action modal-close\">cancelar<\/button></div><\/div><script type=\"text/javascript\">$(\"#alert-72197\").modal({complete: function(e) {  $(\"#alert-72197\").remove(); }}); $(\"#alert-72197\").modal(\"open\");  $(\"#inputButton-ceab0\").click(function(){ preloaderFull(\"on\", pF); setTimeout(function(){ $(\"#alert-72197\").addClass(\"pantalla-full\"); $(\"#alert-72197\").removeClass(\"modal-fixed-footer\"); $(\"#fjfj\").addClass(\"container\"); }, 1000); $.ajax({ url: \"/ajaxmod/{$editar}\", data: ObjHtmlElement, dataType:\"JSON\", type: \"POST\", success: function(data) {setTimeout(function(){ preloaderFull(\"off\", pF); }, 500); $(\"#fjfj\")[0].innerHTML += data[0]; eval(data[1]); $(\"#inputButton-ceab0\").remove(); $(\".afbtn\").prepend(\'<button id=\"modificar\" href=\"#\" class=\"btn btn-flat\">modificar<\/button>\');$(\"#modificar\").click( function(){ $(\"#\"+data[2]+\"\").submit(); } );} });});<\/script><\/div>'
						);	
					}
					});
