...
class main extends createClass
{
	...
	public function refreshInfo(){
		...
		$tempHtml = '<main id="{ID}" class="{TEXTCOLOR} {BACKGROUNDCOLOR} {CONTAINER} {VALIGN} {TEXTALING} {FLOAT} {SHADOW} {TRUNCATE} {CARDPANEL} {HOVERABLE}">{obj:html}</main>';
