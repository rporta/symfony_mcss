...
class col extends createClass
{
	...
	public function reset($arg = NULL)
	{
		...
		$this->s = !isset($arg['s']) ? "12" : $arg['s'];
		$this->m = !isset($arg['m']) ? "12" : $arg['m'];
		$this->l = !isset($arg['l']) ? "12" : $arg['l'];
		$this->xl = !isset($arg['xl']) ? "12" : $arg['xl'];
