...
class collection extends createClass
{
	public $id;
	public $type;
	public $html;
	...
	public function __construct($arg = NULL){
		...
		$this->id = 'collection-'.$this->createID(5);
	...
	public function refreshInfo(){
		...
		$tempHtml = '<div id="{ID}" class="collections {TEXTCOLOR} {BACKGROUNDCOLOR} {CONTAINER} {VALIGN} {TEXTALING} {FLOAT} {SHADOW} {TRUNCATE} {CARDPANEL} {HOVERABLE}">{obj:html}</div>';
