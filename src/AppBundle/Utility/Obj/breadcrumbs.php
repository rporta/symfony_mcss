...
class breadcrumbs extends createClass
{
	...
	public function refreshInfo(){
		...
		$search = array("{ID}", "{obj:html}", "{obj:html:Logo}", "{TEXTCOLOR}", "{BACKGROUNDCOLOR}", "{CONTAINER}", "{VALIGN}", "{TEXTALING}", "{FLOAT}", "{SHADOW}", "{TRUNCATE}", "{CARDPANEL}", "{HOVERABLE}");
		$replace = array($id, $objHtml, $objHtmlLogo, $textColor, $backgroundColor, $container, $valign, $textAling, $float, $shadow, $truncate, $cardPanel, $hoverable);
		$tempHtml = 
		"<nav class='{TEXTCOLOR} {BACKGROUNDCOLOR} {CONTAINER} {VALIGN} {TEXTALING} {FLOAT} {SHADOW} {TRUNCATE} {CARDPANEL} {HOVERABLE}'>
